...
{
	private:
		DigitalOut* CLK;	// Power Down and Serial Clock Input Pin
		DigitalInOut* DATA; // Serial Data Output Pin
	...
	public:
        ...
        void begin(DigitalOut* clk, DigitalInOut* data, uint8_t gain = 128);
